  ...
  return (
    <Link href={href}>
      <a className="flex flex-col max-w-md mb-5 items-center stack-1 shadow bg-gray-200 hover:shadow-lg cursor-pointer">
        <div className="relative flex items-end justify-center bg-clip-border h-64 w-full bg-cover bg-center" style={{ backgroundImage: `url(${bg}?fm=jpg&fl=progressive&w=500)` }}>
